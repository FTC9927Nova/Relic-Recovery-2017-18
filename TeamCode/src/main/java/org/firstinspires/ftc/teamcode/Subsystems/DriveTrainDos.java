...
public class DriveTrainDos implements SubsystemTemplate
{
    ...
    public DriveTrainDos(HardwareMap hardwareMap)
    {
    ...
    public DriveTrainDos(HardwareMap hardwareMap, LinearOpMode opMode)
    {
        l1 = hardwareMap.dcMotor.get("l1");
        l2 = hardwareMap.dcMotor.get("l2");
        r1 = hardwareMap.dcMotor.get("r1");
